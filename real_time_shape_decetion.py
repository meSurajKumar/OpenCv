...
cv2.createTrackbar("Area","Parameters",0,50000,empty)
...
def getContours(video,videocontours):
    ...
    for cnt in contours:
        ...
        if area > areaMin:
            ...
            Here the -1 means how many contours we want to draw we use -1 its mean all.
            and 7 is the thickness.
            '''
...
while True:
    ...
    '''
    videocanny , what is kernal , why videoDil all are explained in previous code
    '''
